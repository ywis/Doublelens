...
If we use another model, and the fitted data just lie on the parabola that is illustrated with black dash dotted lines in the figure, the wellness of the fitting is evaluated by comparing the coverage of the small rectangles over the overlapping area of the parabola and the blue dotted lines on the top and on the right.}
\label{fig:tau-fD}
\end{figure}
