...
\caption{The water reflections of the buildings on the shore. The water reflection of a single light source lie in a straight line. Because the light sources are not close to the edge, we cannot see a separation to the edge, due to the critical angle of reflection.}
...
\caption{A single reflected light path showing the distance degeneracy. O denotes the observer; A and A' are denote the positions of the pulsar; D and D' denote the positions of the reflected images on the ISM. When $D_p=640~pc$, the light path is A-D-O; when $D_p=1240~pc$, the light path is A'-D'-O. They share the same time delay, angular offset and effective distance. }
...
\caption{The geometry of the distance degeneracy of double reflected light path. O denotes the observer; A and A' denote the positions of the pulsar; H and H' denote the positions for the first reflected images; B and B' denote the positions of the second reflected images. When $D_p=640~pc$, the light path is A-H-B-O; when $D_p=1240~pc$, the light path is A'-H'-B'-O. H and H' share the same angular offset, and effective distance. B and B' share the same angular offset and effective distance.}
...
\caption{A 3D version of light path when light is double reflected. Four planes are the plane of the pulsar, plane of lens 1, plane of lens 2 and the observer plane. Light goes from A (pulsar) to the first reflected image D, and then the second reflected image H and then the observer O.}
\label{fig:3D_image}
\end{figure}
