...
-13.86  &    0.9495     &0.0017    & 0.955       & -35.1     &0.64    & -37.22          & -38\\ 
-14.63  &   0.9763    &0.00098   & 0.9763*       & -38.3     &0.70    & -38.31$\dagger$ & -40\\ 
-16.29  &   1.005    &0.0080   & 1.0272          & -40.17    &0.60   & -40.64          & -46\\ 
-16.57  &    1.0370     &0.0032    & 1.036       & -41.27    &0.60   & -41.04          & -47\\ 
-17.44  &  1.0663     &0.0050    & 1.0663*        & -43.08    &0.49   & -42.26           & -50\\ \hline
\end{tabular}
}
...
The values with star symbols on them are the points that we use to calculate the position of J and the point with a $\dagger$ symbol is the point that we use to calculate the velocity of the pulsar $v_{\rm A2}$. The $\chi^2$ of differential frequency $f_D$ is $14$ and the $\chi^2$ of time delay $\tau$ is $4.7$.}
...
plane at position J is missing.  It would have been visible 38 days
