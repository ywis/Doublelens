...
Points with subscripts are dervied from the double lens model, see
...
$\sim 0.01$, which is plausibly measurable.  Even for an unpolarized
...
pairs of scattering points with corrsponding lag and doppler
...
identical to the cross gate secondary spectrum as applied in
