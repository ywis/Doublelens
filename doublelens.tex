...
$D_{1{\rm e}}=1023\pm 27$ pc for the  $0.4$\ ms group, distance of lens 1, and
$D_{2{\rm e}} = 1281 \pm 82$ pc for the $1$\ ms group, distance of lens 2.
...
$D_{\rm [} = 625 \pm 59$ pc.  For modelling purposes, we will use
$D_{\rm [} = 640$ pc, consistent with the direct measurement.  Similarly,
...
We plot the observed relative angular positions in Figure
\ref{Doublelens}. We fit a line to the angular positions of the $0.4$
ms group, at a fixed angle of $\gamma=-25.2\degree$ (east of the
declination axis, from \citet{2010ApJ...708..232B}). We use this axis
...
and $2.0$ for $f_D$ for $4$ degrees of freedom.  This is consistent with
 expected noise.
