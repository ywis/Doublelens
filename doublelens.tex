...
Section \ref{sec:astrometry} covers how we compare the direct measurements of pulsar proper motion to infer the absolute motion of the lensing screen.  
...
about an order of magnitude fainter than the 0.4 ms group, suggesting
that the 1 ms lens is probably less than $\sim$ 1 AU in width.  
