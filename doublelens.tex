...
\end{align*}
, where in $0.4$ ms group, i ranges from 1 to 5, and in $1$ ms group, i ranges from 1 to 9. This is also how we calcualte the population error of RA and dec, marked with circles in Figure \ref{Doublelens}.
