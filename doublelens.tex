...
column of Table \ref{table:apex}, denoted as $t_0$, is
calculated with $-2{\tau}f/{f_{D}}$, corresponding to the time required
...
a common structure.
We denote the position of the pulsar point A, positions of the lensed image on lens 2 point H, positions of the lensed image on lens 1 point B, position of the observer point O, line AJ vertical to line HJ by intersection point J, line HF vertical to line BD by intersection point F, line BG vertical to line HJ by intersection point G, for easier discussion.
...
refraction images would allow a direct determination of the effective
...
example in LOFAR (Low-Frequency Array for radio astronomy) or GMRT (Giant Metrewave Radio Telescope), the size of the scattering screen extends
