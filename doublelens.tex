...
distance \citep{2010ApJ...708..232B} (hereafter B10) of $1168\pm 23$ pc
...
This gibes a value of  $67.9\pm 2.8$ km $\rm s^{-1}$ for $v_{\perp}$, and gives $v_{\rm
  tot}=185.3 \pm 3.3$ km $\rm s^{-1}$, with an angle
$\phi=-3\degree.7$, which is west of north. This represents the
