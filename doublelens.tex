...
Our analysis is based on the apex data selected from the secondary spectrum of pulsar B0834+06 in \citep{2010ApJ...708..232B}, which was observed as part of a global VLBI project on 2005 November 12. 
...
\hline
calculated velocity of the pulsar to earth & $-4.84\pm 0.12$ & $63.4\pm 1.6$ & $41.87\pm 1.06$ & $60.09\pm 1.60$ \\
pulsar proper motion (by VLBI) & $2.14 \pm 0.21$ & $51.64\pm 0.13$ & $45.32\pm 0.49$ & $46.51 \pm 0.20$\\
%earth's heliocentric proper motion & 145.2385 &  -40.7242 &  & \\
...
The reduced chi-square ${\chi}^2_{\nu}$ for time delay $\tau$ is $1.5$ for $3$ degrees of freedom, resulting in the probability of $P<0.10$, and the reduced chi-square ${\chi}^2_{\nu}$ for differential frequency $f_D$ is $2.0$ for $4$ degrees of freedom, resulting in the probability of $P<0.20$.

However, if the lens 1 lines are not parallel, there is still possibility that the differential frequency lie within the error region. Take point 4 for example, $\gamma$ should lie within the region 
$\-25\degree.2000^{+0.0013}_{-0.0006} $.
