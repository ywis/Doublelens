...
\label{firstpage}
\begin{abstract}
Our analysis of archival VLBI data of PSR 0834+06 revealed 
...
This data strongly favours the
...
The axes represent the relative transverse distance to the un-refracted pulsar in Right Ascension (calculated by $x= d\Delta \alpha \cos(\delta)$ with $d$ represent the distance of the object to the observer) and declination (calculated by $y=d\Delta \delta $) directions, on a 2D plane that is transverse to the line of sight. %The screen distances are $388$ pc and $420$ pc for left (lens 1) and right (lens 2) groups respectively. 
...
\caption{A 3D schematic of light path when light is doubly-refracted.  
...
Light goes from $A$ (pulsar) to the first
  ...
  dotted lines show the light path of singly-deflected light path
...
the area in the dotted region.  We interpret this precise agreement
