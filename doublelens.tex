...
\begin{tabular}{|*{8}{l|}}
\hline
Differential Frequency f\_D(mHz) & sample standard deviation\_fD(mHz) & Time delay tau(ms) & sample standard deviation\_tau(ms) & RA(mas) & population standard deviation of RA(mas) & dec(mas) & population standard deviation of Dec(mas) \\
\hline
...
Differential frequency f\_D (mHz) & sigma\_fD & tau(ms) & sigma\_tau (ms) & RA(mas) & population standard deviation of RA(mas) & dec(mas) & population standard deviation of Dec(mas) \\
