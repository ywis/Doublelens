...
\caption{Model angular positions of $0.4$ ms and $1$ ms data in the double
  ...
  sight. The screen distances are $388$ pc and $420$ pc for left and
  right groups
  ...
  motion of the pulsar is $187.9$ km/s, with an angle
...
naturally to the double lens images.  These five matched lines are marked with dot dash lines in Figure \ref{Doublelens} and their values are listed in the first two columns in Table \ref{table:double_lens_compare}. They are the located at a distance $388$ pc away from us. Here we define three distances:
\begin{equation}
\begin{aligned}
...
With $v_{\bot}$ to be $66.8\pm 2.8$ km/s, we find $v_{\rm tot}=187.9 \pm 2.8$ km/s, with an angle $\epsilon=4.34\degree$ west of north. The derived and
