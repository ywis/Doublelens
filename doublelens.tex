...
Light goes from $A$ (pulsar) to the first
  refracted point $H$ on lens 2 (line $HJ$, magenta dash dotted lines), and
  then the second refracted point $D$, the image we observe, on lens 1
  (line $BD$, cyan dash dotted lines), and finally the observer $O$. Dash
