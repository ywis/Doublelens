...
arclets \citet{2001ApJ...549L..97S}.
...
\hline
1& $-17.22$   & $-26.1(4)$    & 0.3743(6)         & 6.2(3)    & $-11.9(3)$      & $-107$                               \\
2& $-16.36$  & $-24.9(4)$      & 0.3378(3)         & 8.0(4)  & $-14.5(8)$      &$-101$                                \\
3& $-16.08$   & $-24.6(4)$       & 0.327(3)   & 7.2(6)  & $-13.9(4)$       & $-99.0$                                \\
4& $-14.45$   & $-22.3(5)$      & 0.2633(3)    & 6.1(3)  & $-13.1(7)$     & $-88.1$                                \\
5& $-13.68$ & $-21.2(6)$        & 0.236(2)    & 5.1(4)  & $-12.7(5)$      & $-83.3$                                \\
6& $-13.27$ & $-20.4(5)$      & 0.222(3)     & 5.8(3)  & $-11.8(1)$    & $-81.4$                                \\
...
$D_{1{\rm e}}=1044\pm 22$ pc for the  $0.4$\ ms group, which we call lens 1 (point 9 is exempted for it exceeds the $3-\sigma$ region of the group), and
...
\caption{Angular positions of $0.4$ ms and $1$ ms group data in one lens model and double lens model. The axes represent the relative distance to the unrefracted pulsar in Right Ascension and declination directions, on a 2D plane that is transverse to the line of sight. %The screen distances are $388$ pc and $420$ pc for left (lens 1) and right (lens 2) groups respectively. 
...
The relative model pulsar-screen velocity is $186.3$ km/s, with an angle $\epsilon=-4\degree$ east of north, is marked with an arrow from the star, point A, at the top of the figure.} 
\label{Doublelens}
\end{figure*}
...
For $v_{\parallel}$, we derive the velocity $173.7 \pm 2.4$ km/s from $f_D$ of point $1$ in $0.4$ ms group.  The direct observable is the time to crossing of each caustic, denoted $t_0$ in Table \ref{table:apex}. 
...
With $v_{\bot}$ to be $67.3\pm 2.8$ km/s, we find $v_{\rm tot}=186.3 \pm 2.8$ km/s, with an angle $\epsilon=-4\degree$, which is west of north. This velocity represents the pulsar's relative velocity to the earth, subtracting the screen's relative velocity to the earth. The model derived and observation velocities (heliocentric and in Local Standard of Rest) are listed in Table \ref{Table:velocity}. The direction of the model velocity is marked on the top of the star in Figure \ref{Doublelens}.
...
\hline
model pulsar-screen velocity & $-6.11 \pm 0.95$  & $62.43 \pm 0.95$  & $-58.02$ & 21.63 &  0 & 0\\
%VLBI pulsar proper motion & $2.14 \pm 0.21$ & $51.64\pm 0.13$ &$45.32\pm 0.49$ %& $46.51 \pm 0.20$\\
VLBI pulsar proper motion & $2.16 \pm 0.19$ & $51.64 \pm 0.13$ & $-46.69$ & 28.02 & -137.24 & 82.34 \\
Screen motion & $\cdots$ & $\cdots$  & 10.27 & 7.83 & 18.94 & 14.44\\
%pulsar proper motion (relative to earth) & $-7.52$ &  $53.5$ & $28.99$  & $52.1$ \\
%l=45.3157,44.8243,45.8071
%b=46.5138,46.3109,46.7166
\hline
...
the relative velocities in LSR (Local Standard of Rest). $\mu_{\alpha*}=\Delta_\alpha*\cos(\delta)/t$ and $\mu_{l*}=\Delta_l*\cos(b)/t$, for we moved the center position from $(\alpha,\delta)$ or $(l,b)$ to (0,0). The screen is
only moving slowly ($\sim 30$km/s).
% Galactic proper motion are listed relative to LSR.
}
\label{Table:velocity}
...
1'& $-17.22$  &  1.0663     &0.0050    & 1.0663*        & $-43.08$    &0.84   & $-42.26$           & $-78$\\
 2'& $-16.36$  &    1.0370     &0.0059    & 1.0362       & $-41.27$    & 0.88   & $-41.04$          & $-75$\\ 
3'& $-16.08$  &   1.005    &0.011   & 1.027          & $-40.17$    &   0.87     & $-40.64$          & $-73$\\ 
 4'& $-14.45$  &   0.9763    &0.00088   & 0.9763*       & $-38.31$     &0.64    & $-38.31\dagger$  & $-63$\\ 
5'& $-13.68$  &    0.9495     &0.0094    & 0.9550       & $-35.06$     &0.78    & $-37.21$          &$-60$\\ 
 \hline
\end{tabular}
%}
...
H to point J. From our calculation, $60$ days earlier the
